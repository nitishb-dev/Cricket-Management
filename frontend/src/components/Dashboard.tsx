  ...
  return (
    <div className="space-y-8 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="text-center py-8">
        ...
        <button
          onClick={() => onNavigate('newMatch')}
          className="inline-flex flex-wrap items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 bg-green-600 text-white text-base sm:text-lg font-semibold rounded-xl hover:bg-green-700 transition-all duration-200 shadow-md hover:shadow-xl transform hover:-translate-y-1"
        >
          <Play size={20} />
          Start New Match
        </button>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              onClick={stat.action}
              className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 p-5 cursor-pointer transform hover:-translate-y-1"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-600 text-sm font-medium">{stat.title}</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-5 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-2">
          ...
          <button
            onClick={() => onNavigate('history')}
            className="text-green-600 font-medium hover:text-green-700 transition-colors text-sm sm:text-base"
          >
            View All
          </button>
        </div>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                  ...
                  <div className="text-sm text-right">
                    <div className="font-semibold text-green-600">{match.winner} Won</div>
                    <div className="text-gray-500">MoM: {match.man_of_match}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-md p-6 text-white">
          <h3 className="text-lg sm:text-xl font-bold mb-2">Manage Players</h3>
          <p className="mb-4 opacity-90 text-sm sm:text-base">Add new players and view their profiles</p>
          <button
            onClick={() => onNavigate('players')}
            className="bg-white text-green-600 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors"
          >
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-md p-6 text-white">
          ...
          <p className="mb-4 opacity-90 text-sm sm:text-base">Analyze player performance and trends</p>
          <button
            onClick={() => onNavigate('stats')}
            className="bg-white text-orange-600 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors"
          >
