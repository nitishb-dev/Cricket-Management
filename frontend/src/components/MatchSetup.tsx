...
//   const [teamAName, setTeamAName] = useState<string>(rematchData?.teamA?.name || 'Team A')
//   const [teamBName, setTeamBName] = useState<string>(rematchData?.teamB?.name || 'Team B')
...
//                       {val} Overs{val === 20 ? ' (T20)' : val === 50 ? ' (ODI)' : ''}
//                     </option>
//                   ))}
//                 </select>
//               </div>
